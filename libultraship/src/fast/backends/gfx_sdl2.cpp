...
#elif defined(USE_OPENGLES) && !defined(__ANDROID__)
    // Desktop GLES build (used to exercise the GLSL ES shader path, e.g. the shader
    // self-test under Mesa): ask for an ES 3.0 context instead of the default desktop GL.
